...
class ApiCalls {
  ...
  Uri viewFile(String filename) {
    return Uri.parse(/*'http://10.200.120.59:5000*/'$urlProd/open_pdf?file_name=$filename');
  }
  ...
  Uri createChangeRequest(){
    return Uri.parse(/*'http://10.200.120.59:5000*/'$urlProd/create_change_request/');
  }

  Uri viewChangeRequests() {
    return Uri.parse('$urlProd/view_change_requests');
  }

  Uri displayChangeRequests() {
    return Uri.parse('$urlProd/submit_change_requests');
  }

  Uri getFileUrl(String fileName) {
    return Uri.parse('$urlProd/get_file/?file_name=$fileName');
  }
